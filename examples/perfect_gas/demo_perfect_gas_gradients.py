...
print(f"  drho/dh|p : {float(grad_fd['rho'][0]):+0.10e} kg*m^-3*kg/J")
print(f"  drho/dp|h : {float(grad_fd['rho'][1]):+0.10e} kg*m^-3/Pa")

print("\npartials (jax):")
print(f"  dT/dh|p   : {float(grad_jax['T'][0]):+0.10e} K*kg/J")
print(f"  dT/dp|h   : {float(grad_jax['T'][1]):+0.10e} K/Pa")
print(f"  drho/dh|p : {float(grad_jax['rho'][0]):+0.10e} kg*m^-3*kg/J")
print(f"  drho/dp|h : {float(grad_jax['rho'][1]):+0.10e} kg*m^-3/Pa")
...
print(f"  drho/dh|p : {rel(grad_fd['rho'][0], grad_jax['rho'][0]):+0.10e}")
