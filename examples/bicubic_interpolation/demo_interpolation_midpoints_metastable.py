...
# p_min = 1.1e5  # Pa
# p_max = 3e6  # Pa
# N_p = 100 # Number of pressure points
# N_h = 100 # Number of enthalpy points
...
p_min = 1e5  # Pa
p_max = 3e6  # Pa
N_p = 128 # Number of pressure points
N_h = 128 # Number of enthalpy points
...
fluid_bicubic = jxp.FluidBicubic(
    ...
    N_h=N_h, N_p=N_p,
    table_dir=outdir,
    # table_name="interpolation_midpoints_metastable",
